                        ...
                        if(!err){
                            if(!utility.issetVal(resData)){
                              ...
                              res.status(200).send(
                                ...
                                let role = {
                                  module_invitedALumni : true,
                                  module_unverifiedALumni : true,
                                  module_verifiedALumni : true,
                                  module_inactiveALumni : true,
                                  module_activeALumni : true,
                                  module_alumni_highlights : true,
                                  module_rejection_emails : true,
                                  module_form_personals : true,
                                  module_post : true,
                                  module_polling : true,
                                  module_postWeekly : true,
                                  module_postMonthly : true,
                                  module_broadcast : true,
                                  module_interest : true,
                                  module_hashtag : true,
                                  module_chatroom : true,
                                  module_event : true,
                                  module_new : true,
                                  module_job : true,
                                  module_lineSevice : true,
                                  module_quote : true,
                                  module_setting : true,
                                  module_company : true,
                                  module_admin : true,
                                ...
                                if(resData.role_id == 'cEejmw2A9geydpChaRQbr0j3t9jBCM6C'){
                                  console.log('Super Admin')
                                  resData.role_name = "Super Admin"
                                  resData.role = role
                                } else if(resData.role_id == '9DNtQf1arPXWWo2KtFKUWzBm6yIgW9Qg'){
                                    resData.role_name = "HR Admin"
                                    role['module_post'] = false,
                                    role['module_polling'] = false,
                                    role['module_postWeekly'] = false,
                                    role['module_postMonthly'] = false,
                                    role['module_broadcast'] = false,
                                    role['module_interest'] = false,
                                    role['module_hashtag'] = false,
                                    role['module_chatroom'] = false,
                                    role['module_event'] = false,
                                    role['module_new'] = false,
                                    role['module_quote'] = false,
                                    role['module_setting'] = false,
                                    role['module_company'] = false,
                                    role['module_admin'] = false,
                                    resData.role = role
                                  console.log('HR Admin')
                                } else {
                                    resData.role_name = "Alumni System Admin"
                                    role['module_lineSevice'] = false,
                                    role['module_job'] = false,
                                    role['module_rejection_emails'] = false,
                                    role['module_form_personals'] = false,
                                    role['module_broadcast'] = false,
                                    role['module_interest'] = false,
                                    role['module_hashtag'] = false,
                                    role['module_chatroom'] = false,
                                    ...
                                    role['module_admin'] = false,
                                    resData.role = role
                                  console.log('Alumni System Admin')
                                }
                                resData.token =  jwt.sign({user_id : resData.id, auth_code :resData.auth_code}, 'RAHASIA')
        ...
        if(!errAuth){
          if(!utility.issetVal(resAuth)){
            ...
            if(resAuth.auth_code == req.body.auth_code){
              ...
              admin.getCountData(bodyCount,function(errResCount,rowsResCount) {
                console.log({errResCount});
                if (!errResCount) {
                 if (utility.issetVal(rowsResCount)) {
                      let itemPerRequest = utility.issetVal(req.body.item)?  parseInt(req.body.item) : 20;
